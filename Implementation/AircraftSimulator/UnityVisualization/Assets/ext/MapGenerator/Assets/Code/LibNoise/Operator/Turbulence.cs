...
namespace LibNoise.Operator
{
    ...
    public class Turbulence : ModuleBase
    {
        ...
        private readonly LibNoise.Generator.Perlin _xDistort;
        private readonly LibNoise.Generator.Perlin _yDistort;
        private readonly LibNoise.Generator.Perlin _zDistort;
        ...
        public Turbulence()
            : base(1)
        {
            _xDistort = new LibNoise.Generator.Perlin();
            _yDistort = new LibNoise.Generator.Perlin();
            _zDistort = new LibNoise.Generator.Perlin();
        }
        ...
        public Turbulence(double power, ModuleBase input)
            : this(new LibNoise.Generator.Perlin(), new LibNoise.Generator.Perlin(), new LibNoise.Generator.Perlin(), power, input)
        {
        }
        ...
        /// <param name="input">The input module.</param>
        public Turbulence(LibNoise.Generator.Perlin x, LibNoise.Generator.Perlin y, LibNoise.Generator.Perlin z, double power, ModuleBase input)
            : base(1)
        {
            _xDistort = x;
            _yDistort = y;
